      ...
      >
        ...
        <ul style={{ listStyle: 'none', padding: expanded ? (isMobile ? '2rem 0 0 0' : '0') : '0', marginTop: '3rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: isMobile ? '2rem' : '1.5rem' }}>
          ...
          {userRole === 'coordenador_futebol' && (
            <>
              {expanded && (
                <li style={{ width: '100%', paddingLeft: isMobile ? '2rem' : '0.5rem', fontSize: '0.75rem', color: '#6b7280', fontWeight: 700, letterSpacing: 1, textTransform: 'uppercase', marginTop: isMobile ? '1rem' : '0.5rem' }}>
                  Futebol
                </li>
              )}
              <li>
