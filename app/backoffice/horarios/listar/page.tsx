    ...
    <div style={{ padding: '2rem', maxWidth: 900, margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1.5rem', flexWrap: 'wrap', gap: '1rem' }}>
        ...
        <Link
          ...
          style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '8px 18px', borderRadius: 10, background: '#7c3aed', color: '#fff', fontWeight: 700, textDecoration: 'none', fontSize: '0.95rem' }}
        >
            ...
            >
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ fontWeight: 700, fontSize: '1rem', color: '#1e293b' }}>
                  {h.diaSemana} — {h.hora}
                  <span style={{ marginLeft: 8, padding: '2px 10px', borderRadius: 99, background: '#ede9fe', color: '#7c3aed', fontSize: '0.82rem', fontWeight: 700 }}>{h.tipo}</span>
                </div>
                {h.paroquia && (
